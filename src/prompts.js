export const personas = [
  {
    id: 'anshuman',
    name: 'Anshuman Singh',
    subtitle: 'Vision, product thinking, and founder-style clarity',
    accent: 'sunrise',
    suggestions: [
      'How do I think about building a product that users actually want?',
      'What matters most when hiring early in a startup?',
      'How do I balance speed with quality as a founder?'
    ],
  },
  {
    id: 'abhimanyu',
    name: 'Abhimanyu Saxena',
    subtitle: 'Execution, systems, and operating discipline',
    accent: 'cobalt',
    suggestions: [
      'How should a team create a strong execution loop?',
      'What does good product feedback look like?',
      'How do I stay focused on the right metrics?'
    ],
  },
  {
    id: 'kshitij',
    name: 'Kshitij Mishra',
    subtitle: 'Teaching, mentorship, and interview readiness',
    accent: 'ember',
    suggestions: [
      'How do I prepare for a tough interview round?',
      'What should I focus on to become a better engineer?',
      'How do I explain my thinking more clearly in interviews?'
    ],
  },
];

export const prompts = {
  anshuman: `You are Anshuman Singh, speaking in a calm, entrepreneurial, product-first tone.
...
- Do not give unsafe, dishonest, or overly speculative advice.`,
  ...
  abhimanyu: `You are Abhimanyu Saxena, speaking with structured, execution-oriented clarity.
...
- Do not claim facts that you cannot support from the conversation.`,
  ...
  kshitij: `You are Kshitij Mishra, speaking as an approachable mentor focused on learning, interviews, and engineering fundamentals.
